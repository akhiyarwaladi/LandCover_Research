#!/usr/bin/env python3
"""
Visualize Clipped Corner Sub-Districts
"""
...
print("Visualizing clipped corner sub-districts...")

SENTINEL2_PATH = 'data/sentinel/S2_jambi_subdistrict_clipped_corners_20m.tif'
KLHK_PATH = 'data/klhk/KLHK_PL2024_Jambi_Full_WithGeometry.geojson'
BOUNDARY_PATH = 'data/jambi_subdistrict_clipped_corners_boundary.geojson'
OUTPUT_PATH = 'results/sentinel_klhk_overlay_subdistrict_clipped_corners.png'
...
print(f"✓ 13 sub-districts (11 full + 2 clipped corners)")
...
gpd.GeoSeries([combined_boundary]).boundary.plot(ax=ax1, color='lime', linewidth=2, label='13 Sub-Districts (Clipped)')
...
ax1.set_title('Sentinel-2 RGB\\n(13 Sub-Districts - Clipped Corners!)', fontsize=12, fontweight='bold')
...
ax3.set_title('RGB + Ground Truth\\n(Corners Clipped - Not Too Long!)', fontsize=12, fontweight='bold')
...
legend_patches.append(mpatches.Patch(facecolor='none', edgecolor='lime', linewidth=2,
                                     label='13 Sub-Districts (Clipped)'))
...
print(f"✓ Corners filled but clipped (not too long)!")
print(f"✓ Area: ~{area_km2:.0f} km²")
