#!/usr/bin/env python3
"""
Visualize Expanded Jambi City Area with KLHK Ground Truth Overlay
==================================================================
...
print("="*80)
print("VISUALIZE EXPANDED CITY + KLHK GROUND TRUTH OVERLAY")
print("="*80)
...
SENTINEL2_PATH = 'data/sentinel/S2_jambi_city_expanded_20m.tif'
KLHK_PATH = 'data/klhk/KLHK_PL2024_Jambi_Full_WithGeometry.geojson'
OUTPUT_PATH = 'results/sentinel_klhk_overlay_expanded_city.png'
...
ax1.set_title('Sentinel-2 RGB Composite\n(Expanded City Area - 36km radius)', fontsize=12, fontweight='bold')
...
print(f"✓ Circular coverage: ~4,066 km²")
