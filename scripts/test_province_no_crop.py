"""Test: Province RGB WITHOUT cropping"""
import sys, os
...
print("\nGenerating province RGB WITHOUT cropping (full mosaic)...")
create_rgb_composite(
    sentinel2_bands, s2_profile, province_boundary,
    'results/TEST_province_NO_CROP.png',
    'Sentinel-2 RGB - Full Mosaic (No Crop)',
    skip_crop=True
)

print("\n✅ Saved: results/TEST_province_NO_CROP.png")
print("   Full satellite mosaic - NO black/white boxes!")
